...
const Ai = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      const res = await fetch(
        "https://metrimony-server-site.vercel.app/api/chat",
        {
          method: "POST",
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 rounded-2xl shadow-2xl border border-gray-700">
      ...
      {/* Chat area */}
      <div className="h-[300px] overflow-y-auto bg-gray-900/60 border border-gray-700 rounded-xl p-4 mb-6 shadow-inner backdrop-blur-md space-y-4">
        {messages.length === 0 && (
