...
const Ai = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-100 rounded-2xl shadow-2xl border border-gray-700">
